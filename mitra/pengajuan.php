...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO usulan (nama, alamat, nama_penandatangan, jabatan, nama_kontak, no_kontak, email, dokumen)
            VALUES ('$nama', '$alamat', '$nama_penandatangan', '$jabatan', '$nama_kontak', '$no_kontak', '$email', '$dokumen')";
