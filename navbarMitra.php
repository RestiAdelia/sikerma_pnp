...
<body>
    ...
    <div class="container-fluid">
            ...
            <a class="navbar-brand text-white" href="#">Mitra Dashboard</a>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <hr class="text-white">
        <a href="navbarMitra.php?p=dashboard"><i class="fas fa-home"></i> Dashboard</a>
        <a href="navbarMitra.php?p=kegiatan"><i class="fas fa-walking"></i> Kegiatan</a>
        <a href="navbarMitra.php?p=daftarmitra"><i class="fa fa-table"></i>Daftar Mitra</a>
        <a href="navbarMitra.php?p=usulan"><i class=" 	fas fa-clipboard"></i> Usulan Kerjasama</a>
